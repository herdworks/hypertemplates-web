...
title: hyperctl theme install
summary: |
    `hyperctl theme install` reference documentation.
breadcrumb: complete
---
...
```plaintext
$ hyperctl theme install -h
Install a theme from a package archive.

Usage:
        hyperctl theme install [options]
...
**`-f`, `--file`**
: Path to the theme archive file to be installed (e.g. `Minimal-v0.1.0.zip`).
