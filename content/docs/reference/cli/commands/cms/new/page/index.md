...
title: hyperctl cms new page
summary: |
    `hyperctl cms new page` command reference document.
breadcrumb: page
---
...
The `hyperctl cms new page` command creates a new page index file in an existing website.

### Usage
---------

```plaintext
$ hyperctl cms new page -h
Create a new page.

Usage:
        hyperctl cms new page [options]
...
: The new page description.
  ...
  **Example**
  ...
  ```plaintext
  --description "hyperctl cms new page command reference"
  ```
