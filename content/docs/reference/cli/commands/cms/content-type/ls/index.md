...
title: hyperctl cms content-type ls
summary: |
    `hyperctl cms content-type ls` reference documentation
breadcrumb: ls
---

## `hyperctl cms content-type ls` command
...
The `hyperctl cms content-type ls` command lists available [content types] for the configured HyperTemplates theme.

### Usage
---------

```plaintext
$ hyperctl cms content-type ls -h
List content types.

Usage:
        hyperctl cms content-type ls [options]
