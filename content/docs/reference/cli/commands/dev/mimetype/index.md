...
title: hyperctl dev mimetype
summary: |
    `hyperctl dev mimetype` command reference documentation.
breadcrumb: mimetype
---
...
```plaintext
$ hyperctl dev mimetype -h
Get file mimetype information.

Usage:
        hyperctl dev mimetype [options] <path>
...
```plaintext
$ hyperctl dev mimetype theme/static/favicon.png
