...
<code-snippet ht-element filename='content/blog/introducing-hypertemplates/index.md'>
...
: The page layout.
  ...
  **Example**
  ...
  <code-snippet ht-element filename='content/index.md' highlight='3'>
...
: The page author.
  ...
  **Sample**
  ...
  <code-snippet ht-element filename='content/blog/introducing-hypertemplates' highlight='7-11'>
...
: The page content.
  ...
  **Sample**
  ...
  <code-snippet ht-element filename='content/blog/hello-world/index.md' highlight='6-9'>
...
: A list of page metadata properties.
  ...
  **Sample**
  ...
  <code-snippet ht-element filename='content/about/index.md' highlight='5-21'>
...
: A list of page links, or [relationships], to other resources.
  ...
  **Sample**
  ...
  <code-snippet ht-element filename='content/about/index.md' highlight='5-9'>
...
: The page tags.
  ...
  **Sample**
  ...
  <code-snippet ht-element filename='content/blog/hello-world/index.md' highlight='4-7'>
...
: The `page.redirect` property is used to indicate that a page should redirect to another URL.
  ...
  **Samples**
  ...
  <code-snippet ht-element filename='content/jobs/index.md' highlight='4'>
  ...
  <code-snippet ht-element filename='content/livestream/index.md' highlight='4'>
...
: The `page.refresh` property is a computed property used for configuring redirects.
  ...
  **Example**
  ...
  <code-snippet ht-element filename='redirect.html'>
...
: The `page.draft` boolean property is used to determine whether a page is generated during a build.
  ...
  **Sample**
  ...
  <code-snippet ht-element filename='content/blog/hello-world/index.md' highlight='4'>
...
: The `page.unlisted` boolean property is used to determine whether a page is included in a feed.
  ...
  **Sample**
  ...
  <code-snippet ht-element filename='content/newsletter/2025-community-event/index.md' highlight='4'>
...
: The page feed configuration.
  ...
  **Examples**
  ...
  <code-snippet ht-element filename='content/blog/index.md' highlight='4-6'>
  ...
  **NOTE**: this example was abbreviated to `/blog/*` for simplicity, but it is effectively equivalent to `*/blog/*` which might yield unexpected results.
  ...
  <code-snippet ht-element filename='content/releases/index.md' highlight='4-8'>
...
: A list of pages matching one or more feed filters (`page.feed.tags` or `page.feed.paths`).
  ...
  **Example**
  ...
  <code-snippet ht-element filename='theme/partials/feed.html' highlight='2-9'>
  ...
  <section id='feed'>
      <feed-entry ht-template='entry:page.feed.pages'>
          ...
          <learn-more ht-element ht-attrs='href:entry.path' label='Continue reading'></learn-more>
      </feed-entry>
  </section>
  ```
...
: All properties defined in page index files are available as [template data properties] with the `page.` prefix.
  ...
  **Example**
  ...
  <code-snippet ht-element filename='content/about/index.md' highlight='6-9'>
...
: Create your first blog using feed pages!
  ...
  <learn-more ht-element href='/docs/guides/feed-pages'>
